...
const DynamicFlatUI = ({ data }: DynamicFlatUIProps) => {
  ...
  return (
    <motion.div
      ...
      animate="animate"
      exit="exit"
      className="shadow-md *:text-sm rounded-3xl p-6 max-w-3xl mx-auto my-8 bg-[#F5ECD5] dark:bg-[#212121]"
    >
      <div className="flex justify-center">
        <div className="flex items-center space-x-3 bg-black p-5 w-fit rounded-3xl">
